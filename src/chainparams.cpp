...
public:
    CMainParams() {
        ...
        consensus.nMinerConfirmationWindow = 256; // nPowTargetTimespan / nPowTargetSpacing
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1; // April 24th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 2; // August 11th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 3; // Approximately November 12th, 2021
